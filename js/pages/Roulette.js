...
export default {
        ...
        <main v-else class="page-roulette">
            <div class="sidebar">
                <p class="type-label-md" style="color: #aaa">
                    Shameless copy of the Extreme Demon Roulette by <a href="https://github.io" target="_blank">matcool</a>.
                </p>
                <form class="options">
                    <div class="check">
    ...
    methods: {
        ...
        async onStart() {
            ...
            if (!fullList || !Array.isArray(fullList) || fullList.filter(([_, err]) => err).length > 0) {
                this.loading = false;
                this.showToast(
            ...
            if (this.useExtendedList) list.push(...fullListMapped.slice(75));

            this.levels = this.shuffle(list).slice(0, 100);
            this.progression = [];
            this.givenUp = false;
